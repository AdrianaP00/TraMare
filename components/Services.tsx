  ...
  return (
    <section id="servizi" className="py-24 md:py-32">
      <div className="mx-auto max-w-6xl px-6">
        <SectionHeading
          eyebrow="Servizi"
          title="Tutto ciò che serve, già incluso"
          description="Ogni dettaglio del vostro soggiorno è pensato per offrirvi comfort senza pensieri, dal primo caffè all'ultimo rientro serale."
        />
